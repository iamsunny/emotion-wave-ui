...
import { Home, SmilePlus, Award, CalendarDays, Menu, X } from "lucide-react";
      ...
      <div className="container max-w-4xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="hidden sm:flex items-center space-x-1">
            <Link to="/" className="flex items-center space-x-2 font-bold text-lg text-emotion-deep-purple">
